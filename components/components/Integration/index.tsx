      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `We Remotely Maintain Your Product, From Anywhere, Anytime.`,
              description: `"SpinkTech ensures seamless product maintenance remotely, offering comprehensive support and updates from any location, at any time, ensuring continuous reliability and performance for your business."`,
            }}
          />
